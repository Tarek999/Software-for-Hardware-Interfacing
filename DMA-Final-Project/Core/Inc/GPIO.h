...
//control register 1
#define USART_CR1 (GPIO_REG(USART2,0x0C))
//control register 2
#define USART_CR2 (GPIO_REG(USART2,0x10))
// baud rate register
#define USART_BRR (GPIO_REG(USART2,0x08))
//data register
#define USART_DR (GPIO_REG(USART2,0x04))
//status register
#define USART_SR (GPIO_REG(USART2,0x00))
